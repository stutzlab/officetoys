...
srv:listen(80,function(conn)
    conn:on("receive", function(client,request)
        ...
        if(showIndex) then
           ...
           buf = buf.."<html><head><title>Cozme Alarme - Selecione a Rede</title></head>";
           buf = buf.."<body>";
           buf = buf.."<h2>Conecte o Cozme Alarme a sua rede Wifi</h2>";
